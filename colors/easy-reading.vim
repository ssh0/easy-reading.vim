...
if version >= 700
  hi CursorLine cterm=None  ctermfg=None ctermbg=235 gui=None guifg=#1c1c1c guibg=#262626
  hi MatchParen cterm=None  ctermfg=None ctermbg=239 gui=None guifg=#1c1c1c guibg=#4e4e4e
